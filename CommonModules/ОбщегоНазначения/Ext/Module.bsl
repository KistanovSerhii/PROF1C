...
//
&НаСервере
Процедура НаполнитьПанельСчетчикБилетов(ЭкзаменационнаяФорма, НаборБилетовЭкзамена)
	
	ПанельСчетчикБилетов = ЭкзаменационнаяФорма.Элементы.ПанельСчетчикБилетов;
	Для каждого Билет Из НаборБилетовЭкзамена Цикл
